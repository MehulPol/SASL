...
website1 = "https://www.foxsports.com/college-basketball/virginia-cavaliers-vs-north-carolina-state-wolfpack-jan-06-2024-game-boxscore-245746?tab=playbyplay"
...
# write.csv(game1, "NCST_game.csv", row.names=FALSE)
...
# write.csv(All_Stats, "NCST_stats.csv", row.names=FALSE)
